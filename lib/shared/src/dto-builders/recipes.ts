...
export class RecipeListItemDtoBuilder extends DtoBuilder<IRecipeListItemDto> {
  ...
  withReview(review: number): this {
    return this.withProperty('review', review);
  }

  withoutCoverImage(): this {
    return this.withProperty('coverImage', null);
  }
}
...
export class RecipeDtoBuilder extends DtoBuilder<IRecipeDto> {
  ...
  easy(): this {
    return this.withProperty('difficulty', RecipeDifficulty.easy);
  }

  withoutAuthor(): this {
    return this.withProperty('authorId', null);
  }

  withoutReview(): this {
    return this.withProperty('review', null);
  }
